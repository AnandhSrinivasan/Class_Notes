 ...
 * method overriding is used to give a different implementation in the child class
 * It comes with parent child relationship. method overriding will happen in the child class
 * Same method signature--> no difference in the no. of arguments and no difference in the data types of the arguments
 */
...
public class Method_OverridingEx1 extends Bike{
	...
	public static void main(String[] args) {
		...
		Method_OverridingEx1 obj = new Method_OverridingEx1();
